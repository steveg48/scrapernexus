          ...
          <div className="p-6 border-b">
            <div className="flex justify-between items-start">
              ...
              <div className="flex flex-col gap-3">
                <button 
                  className="px-6 py-2 bg-green-600 text-white rounded-md hover:bg-green-700 transition-colors min-w-[140px]"
                  onClick={() => router.push(`/seller/jobs/apply/${job.id}`)}
                >
                  Apply now
                </button>
                <button 
                  className="px-6 py-2 border border-gray-300 rounded-md hover:bg-gray-50 transition-colors flex items-center justify-center gap-2 min-w-[140px]"
