                  ...
                  <div key={posting.id} className="border-t pt-6">
                    ...
                    <div className="flex justify-between items-start mb-3">
                      ...
                      <div className="text-lg font-medium text-green-600">
                        {formatBudget(posting.budget)}
                      </div>
                    </div>

                    {/* Description */}
                    <p className="text-gray-700 mb-4 whitespace-pre-line">{posting.description}</p>

                    {/* Project Details */}
                    <div className="grid grid-cols-2 gap-4 mb-4 text-sm">
                      <div>
                        <span className="font-medium text-gray-700">Posted by:</span>
                        <span className="ml-2 text-gray-600">{posting.buyer_name}</span>
                      </div>
                      <div>
                        <span className="font-medium text-gray-700">Posted on:</span>
                        <span className="ml-2 text-gray-600">{formatDate(posting.created_at)}</span>
                      </div>
                      {posting.project_type && (
                        <div>
                          <span className="font-medium text-gray-700">Type:</span>
                          <span className="ml-2 text-gray-600">{posting.project_type}</span>
                        </div>
                      )}
                      {posting.frequency && (
                        <div>
                          <span className="font-medium text-gray-700">Frequency:</span>
                          <span className="ml-2 text-gray-600">{posting.frequency}</span>
                        </div>
                      )}
                      {posting.project_location && (
                        <div>
                          <span className="font-medium text-gray-700">Location:</span>
                          <span className="ml-2 text-gray-600">{posting.project_location}</span>
                        </div>
                      )}
                    </div>
