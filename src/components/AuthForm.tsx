  ...
  return (
    <form onSubmit={handleAuth} className="space-y-4">
      ...
      <button
        type="submit"
        disabled={isLoading}
        className="w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-[#3c8dd5] hover:bg-[#3c8dd5]/90 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#3c8dd5] disabled:opacity-50"
      >
